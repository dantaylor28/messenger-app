    ...
    <>
      <div
        className={`flex gap-4 py-2 px-2 rounded-sm items-center cursor-pointer ${
          isSelected ? "bg-[#cb874a]/90 md:bg-amber-500/50 dark:bg-white/10" : "hover:bg-[#cb874a]/40 md:hover:bg-amber-500/20 dark:hover:bg-white/5"
        }`}
        onClick={handleClick}
      >
      ...
      {!lastIndex && (
        <hr className="bg-white opacity-20 md:bg-black md:opacity-100 dark:opacity-5" />
      )}
    </>
  );
};
